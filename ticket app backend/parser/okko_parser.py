...
def find_genre(title):
    genre_exist = requests.get('http://23.111.123.117:8000/films/1/genres/')
...
def find_country(name):
    data = requests.get('http://23.111.123.117:8000/films/1/country/')
...
def find_user(name, type):
    data = requests.get(f'http://23.111.123.117:8000/films/1/{type}/')
...
for i in res.json()['element']['collectionItems']['items']:
    if(count<0):
        ...
        if(film['type'] == "MOVIE"):
            ...
            trailer_data = requests.post('http://23.111.123.117:8000/films/1/trailer/', data=trailer_data)
            ...
            for country in film_detail['countries']['items']:
                ...
                if(id):
                    ...
                    countries_data = requests.post('http://23.111.123.117:8000/films/1/country/', data)
            ...
            for director in film_detail['directors']['items']:
                ...
                if(id):
                    ...
                    directors_data = requests.post('http://23.111.123.117:8000/films/1/director/', data)
            ...
            for genre in film_detail['genres']['items']:
                ...
                if(id):
                    ...
                    new_genre = requests.post('http://23.111.123.117:8000/films/1/genres/', data=new_genre_data)
            ...
            for actor in film_detail['actors']['items']:
                ...
                if(id):
                    ...
                    actors_data = requests.post('http://23.111.123.117:8000/films/1/actor/', data)
            ...
            create_film = requests.post('http://23.111.123.117:8000/films/', data=film_data)
            print(create_film.json()['name'])
    count-=1 
