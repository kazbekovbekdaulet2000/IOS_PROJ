...
def find_genre(title):
    genre_exist = requests.get('http://23.111.123.117:8000/films/5/genres/')
...
# def find_film(name):
#     all_films = requests.get('http://23.111.123.117:8000/films/')
        ...
        for genre in film['genres']:
            if(find_genre(genre['title']) == None):
                ...
                new_genre = requests.post(
                    'http://23.111.123.117:8000/films/5/genres/', data=new_genre_data)
